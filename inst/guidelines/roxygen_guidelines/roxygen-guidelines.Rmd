---
title: "Roxygen documentation guidelines"
...
* Use [**markdown**](https://cran.r-project.org/package=roxygen2/vignettes/markdown.html):
...
knitr::read_chunk(system.file("examplePkgs", "roxygenExPkg", "R", "fun_doc.R", package = "techguides"), labels = "example")
```
```{r example}
```
...
knitr::read_chunk(system.file("examplePkgs", "roxygenExPkg", "R", "fun_doc_tpl.R", package = "techguides"), labels = "example_tpl")
```
```{r example_tpl}
```
#### `@describeIn`
...
knitr::read_chunk(system.file("examplePkgs", "roxygenExPkg", "R", "times_describeIn.R", package = "techguides"), labels = "ex-describeIn")
```
```{r ex-describeIn}
```
