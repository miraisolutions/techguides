...
principles. #> @Riccardo to understand how to link package here
...
<!-- knitr::read_chunk("../R/fun_doc.R", labels = "example") -->
<!-- ``` -->
<!-- ```{r example} -->
<!-- ``` -->
...
<!-- knitr::read_chunk("../R/fun_doc_tpl.R", labels = "example_tpl") -->
<!-- ``` -->
<!-- ```{r example_tpl} -->
<!-- ``` -->
<!-- ### `@describeIn` -->
...
<!-- knitr::read_chunk("../R/times_describeIn.R", labels = "ex-describeIn") -->
<!-- ``` -->
<!-- ```{r ex-describeIn} -->
<!-- ``` -->
