...
knitr::read_chunk(file.path("../../examplePkgs", "roxygenExPkg", "R", "fun_doc.R"), labels = "example")
```
```{r example}
```
...
knitr::read_chunk(file.path("../../examplePkgs", "roxygenExPkg", "R", "fun_doc_tpl.R"), labels = "example_tpl")
```
```{r example_tpl}
```
#### `@describeIn`
...
knitr::read_chunk(file.path("../../examplePkgs", "roxygenExPkg", "R", "times_describeIn.R"), labels = "ex-describeIn")
```
```{r ex-describeIn}
```
