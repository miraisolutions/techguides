...
The corresponding `steps` are defined the workflow's `.yml` file as follows

```{r read-ci-cd.yml, eval = TRUE, echo = FALSE}
...
```{r}
usethis::use_github_action("https://tinyurl.com/mirai-techguide/shiny-ci-cd/actions/ci-cd.yml") # or ci-cd-renv.yml
